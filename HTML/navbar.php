            ...
            ?>
                    <div class="container">
                        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 border-bottom bg-light">
                            ...
                            <div class="ms-3 me-1" >
                                <a id="cartTrigger" href="../user/userProducts.php" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none ms-2 "data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
