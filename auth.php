...
<div>
    <form method="post" action="controls.php">
        <div class="form-floating m-3" style="text-indent: 10px;">
            ...
            <label for="floatingPassword">Activation Code</label>
        </div>
        <div class="col-auto m-3">
            <button type="submit" class="btn btn-primary mt-3 mb-3" name="activationCodeSubmit">Activation Code Submit</button>
        </div>
    </form>
</div>
